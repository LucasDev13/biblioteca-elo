insert into tbl_contact (id, email, phone_number) values('8dda0854-2074-447c-9276-dd71555b7a74', 'lucas.pontes@gmail.com', '222222222222');

insert into tbl_person (id, name, contact_id)
values  ('c818e310-a992-4d63-959b-8ef1ba20a8f3', 'Lucas Pontes', '8dda0854-2074-447c-9276-dd71555b7a74'),
        ('ea21bd73-77b5-4236-824a-b8c8de338946', 'Lucas Castro', '8dda0854-2074-447c-9276-dd71555b7a74'),
        ('0c237a5a-c3c6-4642-8088-82f7bdbae4dc', 'Thais Rodrigues', '8dda0854-2074-447c-9276-dd71555b7a74'),
        ('2880e4cb-29f7-49cf-8977-bd48ab74f656', 'Margarida Souza', '8dda0854-2074-447c-9276-dd71555b7a74');

insert into tbl_users(id, login, password, person_id, user_role, create_at, update_at)
values  ('e9216d32-e717-48f8-9700-3361a3ef2f2d', 'Lucas Pontes', '1111', 'c818e310-a992-4d63-959b-8ef1ba20a8f3', 'ADMIN', now(), now()),
        ('bb839ee4-54a1-42b3-b5c2-57997167ae22', 'Lucas Castro', '2222', 'ea21bd73-77b5-4236-824a-b8c8de338946', 'USER', now(), now()),
        ('385491a9-be4c-4132-9b01-6fe3b6a61dee', 'Thais Rodrigues', '3333', '0c237a5a-c3c6-4642-8088-82f7bdbae4dc', 'USER', now(), now()),
        ('af9dfac2-fb45-4a31-97d6-d5dbf4d0d50c', 'Margarida Souza', '4444', '2880e4cb-29f7-49cf-8977-bd48ab74f656', 'USER', now(), now());

insert into tbl_categories (id, name)
values ('41f0284c-e740-4842-9c3b-5258715f267a', 'Fiction'),
...
values
    ...
    ('2db3d44b-8c44-4c70-8547-e0e44c871157', (select id from tbl_users where login = 'Lucas Castro'), (select id from tbl_books where title = 'The Great Gatsby'), '2024-01-10', '2024-10-27', 'ACTIVE'),
    ('ff9c2fbd-3748-47a9-8a1a-756483a3b7c2', (select id from tbl_users where login = 'Lucas Castro'), (select id from tbl_books where title = 'Clean Code'), '2024-01-15', '2024-10-27', 'ACTIVE'),
    ('fee0cd38-6a84-41f1-8d0a-eb981a43be62', (select id from tbl_users where login = 'Thais Rodrigues'), (select id from tbl_books where title = 'The Pragmatic Programmer'), '2024-01-20', '2024-10-27', 'ACTIVE'),
    ('0101afe8-73e8-4409-955f-b76d5e91a382', (select id from tbl_users where login = 'Margarida Souza'), (select id from tbl_books where title = 'Sapiens: A Brief History of Humankind'), '2024-02-01', '2024-10-27', 'ACTIVE');
